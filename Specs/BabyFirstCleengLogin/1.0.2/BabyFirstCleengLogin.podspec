Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |c|
    c.frameworks = 'UIKit'
    c.public_header_files = 'BabyFirstCleengLogin/Classes/*.h'
    c.source_files = 'BabyFirstCleengLogin/Classes/**/*.{h,m,swift}'
    c.resource_bundles = {
        'cleeng-storyboard' => ['BabyFirstCleengLogin/Storyboard/*.{storyboard,png,xib}']
    }
